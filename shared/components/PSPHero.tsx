...
/**
 * PSP Hero section component
 */
export function PSPHero() {
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div ref={heroContent.ref as React.RefObject<HTMLDivElement>} style={heroContent.style} className="text-white z-10">
            <h1 className="text-4xl sm:text-5xl md:text-[57px] lg:text-[57px] font-bold leading-[1.2] mb-6 font-heading text-white text-left">
              How to become a PSP without development efforts
            </h1>
            <p className="text-[18px] text-white/90 mb-8 max-w-xl leading-relaxed font-body text-left">
              The payment service provider market will more than double in the coming years, growing from roughly $40 billion in 2019 to a staggering $88 billion in 2027. Join this snowballing market by establishing your own PSP company without significant investments.
            </p>
