...
export function WellOrderedStatements() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'BrosPay securely stores every transaction statement, while ensuring its availability for your further reference.',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'BrosPay detects and alerts you about any mismatches in statements, granting consistency and facilitating the payment reconciliation process.',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
