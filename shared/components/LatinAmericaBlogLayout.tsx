...
/**
 * Latin America Blog Layout - matches BrosPay blog post design
 */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6 font-heading">
                How BrosPay helps enter the Latin American market
              </h2>
              <p className="text-[18px] text-gray-700 leading-relaxed mb-6 font-body">
                At BrosPay, we provide growing businesses with a holistic platform for efficiently entering and performing in new markets. Our solution allows connecting new payment methods in a few clicks and enables working with multiple payment providers conveniently, managing everything in a single place. Working with BrosPay, you get a dedicated manager with a deep understanding of the global payment market and experience in dealing with payment providers and acquirers, who will eagerly help you scale up efficiently.
              </p>
              <p className="text-[18px] text-gray-700 leading-relaxed mb-6 font-body">
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-8">
              ...
              <div className="bg-yellow-50 border-2 border-yellow-200 rounded-[20px] p-6 mb-8">
                ...
                <p className="text-gray-700 mb-4 font-body">
                  Discover how BrosPay can help you expand into Latin American markets.
                </p>
                <Link
                  href="#book-call"
              ...
              <div className="bg-green-50 border-2 border-green-200 rounded-[20px] p-6">
                ...
                <p className="text-gray-700 mb-4 font-body">
                  Learn how BrosPay can help you optimize your payment processes for Latin American markets.
                </p>
                <Link
