...
/**
 * Financial Institution Hero section component
 */
export function FinancialInstitutionHero() {
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div ref={heroContent.ref as React.RefObject<HTMLDivElement>} style={heroContent.style} className="text-white z-10">
            ...
            <p className="text-[18px] text-white/90 mb-8 max-w-xl leading-relaxed font-body text-left">
              The financial service industry has become increasingly complex, with various challenges and opportunities. Payment processing has become an increasingly important part of the financial services sector, yet it is also one of the most challenging aspects.
            </p>
          ...
          {/* Right Content - Financial Institution Image */}
          <div ref={heroImage.ref as React.RefObject<HTMLDivElement>} style={heroImage.style} className="relative hidden lg:block">
            <div className="relative w-full h-full flex items-center justify-center">
              <img
                ...
                alt="Financial institution payment challenges"
