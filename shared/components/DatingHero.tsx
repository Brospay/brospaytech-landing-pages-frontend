...
/**
 * Dating and Adult Hero section component
 */
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div ref={heroContent.ref as React.RefObject<HTMLDivElement>} style={heroContent.style} className="text-white z-10">
            ...
            <p className="text-[18px] text-white/90 mb-8 max-w-xl leading-relaxed font-body text-left">
              The dating industry is booming, and by 2027, the number of users is expected to reach around 440 million worldwide. If you're planning to launch a dating platform or provide payment services for one, setting up reliable and secure online dating credit card processing is essential.
            </p>
          ...
          <div ref={heroImage.ref as React.RefObject<HTMLDivElement>} style={heroImage.style} className="relative hidden lg:block">
            <div className="relative w-full h-full flex items-center justify-center">
              <img
                ...
                alt="Online dating payment processing"
