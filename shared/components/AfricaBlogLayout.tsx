...
/**
 * Africa Blog Layout - matches BrosPay blog post design
 */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6 font-heading">
                How BrosPay helps enter the African market
              </h2>
              <p className="text-[18px] text-gray-700 leading-relaxed mb-6 font-body">
                At BrosPay, we provide growing businesses with a holistic platform for efficiently entering and performing in African markets. Our solution allows connecting new payment methods in a few clicks and enables working with multiple payment providers conveniently, managing everything in a single place.
              </p>
              <p className="text-[18px] text-gray-700 leading-relaxed mb-6 font-body">
                Working with BrosPay, you get a dedicated manager with a deep understanding of the global payment market and experience in dealing with payment providers and acquirers across Africa, who will eagerly help you scale up efficiently.
              </p>
              <p className="text-[18px] text-gray-700 leading-relaxed mb-6 font-body">
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-8">
              ...
              <div className="bg-yellow-50 border-2 border-yellow-200 rounded-[20px] p-6 mb-8">
                ...
                <p className="text-gray-700 mb-4 font-body">
                  Discover how BrosPay can help you expand into African markets.
                </p>
                <Link
                  href="#book-call"
              ...
              <div className="bg-orange-50 border-2 border-orange-200 rounded-[20px] p-6">
                ...
                <p className="text-gray-700 mb-4 font-body">
                  Learn how BrosPay can help you integrate mobile money and other African payment methods.
                </p>
                <Link
                  href="/marketplace"
                  className="block w-full text-center px-6 py-3 bg-[#4730B8] text-white rounded-[10px] font-semibold hover:bg-[#5a3fc9] transition-colors font-body"
