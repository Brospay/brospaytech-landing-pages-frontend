...
export function GamblingEducation() {
  ...
  const faqs = [
    ...
    {
      question: 'What payment challenges do gambling businesses face, and how can BrosPay help overcome them?',
      answer: 'Running an online gambling business comes with unique payment hurdles. At BrosPay, our gambling payment gateway is built to help operators and platforms tackle them head-on: Getting a merchant account – with 550+ high-risk-friendly providers already integrated, you only need to connect your MIDs to start processing. Offering the right payment methods – from cards and e-wallets to crypto, we help you add the payment options players in your markets prefer. Managing deposits and payouts – accept and send payments through multiple channels with equal speed and reliability. Reducing chargebacks – use our advanced risk tools to keep chargeback rates low and protect your accounts. Navigating high-risk conditions – lower fraud exposure, meet global compliance standards, and optimise costs in a high-fee industry.',
    },
    {
