...
import { HistoricalUptime } from '@/shared/components'
import { Navigation, Footer, ScrollToTop } from '@/shared/components'

export default function HistoricalUptimePage() {
  return (
    <main className="min-h-screen flex flex-col bg-[#EFEFEF] overflow-x-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12 lg:mb-16">
                ...
                <p className="text-[18px] text-white mb-6 max-w-3xl mx-auto text-center leading-relaxed font-body">
                  View detailed uptime history for all ValoraPay services
                </p>
              </div>
            </div>
          </section>
      ...
      <section aria-label="Historical Uptime">
        <HistoricalUptime />
      </section>
