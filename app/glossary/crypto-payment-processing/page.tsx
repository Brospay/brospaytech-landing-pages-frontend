...
/**
 * Crypto Payment Processing glossary detail page
 * Displays comprehensive information about cryptocurrency payment processing
 */
export default function CryptoPaymentProcessingPage() {
  return (
    <main className="min-h-screen flex flex-col bg-[#EFEFEF] overflow-x-hidden">
      ...
      <section aria-label="Glossary Detail">
        <GlossaryDetail termId="crypto-payment-processing" />
      </section>
