...
import { DocumentationDetail } from '@/shared/components'
...
export default function DocumentationDetailPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-[#EFEFEF] overflow-x-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12 lg:mb-16">
                ...
                <p className="text-[18px] text-white mb-6 max-w-3xl mx-auto text-center leading-relaxed font-body">
                  Resources and tools to integrate ValoraPay payment platform
                </p>
              </div>
            </div>
          </section>
      ...
      <section aria-label="Documentation Detail">
        <DocumentationDetail slug={slug} />
      </section>
