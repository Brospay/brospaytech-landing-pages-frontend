...
import { Navigation, Footer, ScrollToTop, PaymentProviders } from '@/shared/components'

const geoUrl = 'https://cdn.jsdelivr.net/npm/world-atlas@2/countries-110m.json'

/**
 * Payment Providers page component
 * Displays the global payment service providers list with filters and information
 */
  ...
  return (
    <>
      <main className="min-h-screen flex flex-col bg-[#EFEFEF] overflow-x-hidden">
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-12">
                  ...
                  <div>
                    <h1 className="text-[2.4rem] font-medium text-white mb-6 leading-[3.05563rem] tracking-[-0.075rem] font-body text-left">
                      Payment service providers&apos; catalogue
                    </h1>
        ...
        <section aria-label="Payment Providers">
          <PaymentProviders initialContinent={selectedContinent} />
        </section>
