...
import { Navigation, Footer, ScrollToTop, Contacts } from '@/shared/components'
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12 lg:mb-16">
                  ...
                  <p className="text-[18px] text-white mb-6 max-w-3xl mx-auto text-center leading-relaxed font-body">
                    We&apos;re happy to answer any questions you may have. Just send an email to the relevant department.
                  </p>
                </div>
              </div>
            </section>
