...
import { Navigation, Footer, ScrollToTop, PaymentMaturityQuiz } from '@/shared/components'

/**
 * Test Drive / Payment Maturity Quiz page
 * Interactive quiz to determine payment maturity level
 */
  ...
  return (
    <>
      <main className="min-h-screen flex flex-col bg-[#EFEFEF] overflow-x-hidden">
        ...
        <section aria-label="Payment Maturity Quiz">
          <PaymentMaturityQuiz />
        </section>
